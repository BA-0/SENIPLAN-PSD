...
>(({ className, children, ...props }, ref) => (
  <AccordionPrimitive.Header className="flex">
    <AccordionPrimitive.Trigger
      ref={ref}
      className={cn(
        "flex flex-1 items-center justify-between py-3 text-[13px] font-medium text-foreground transition-all hover:text-primary-600 [&[data-state=open]>svg]:rotate-180",
        className
      )}
      {...props}
    >
